...
#define SPI_MISO_PIN            5                                     // NOT USED IN THIS PROJECT
...
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=*/ 10, /*DC=*/ 0, /*RST=*/ 2, /*BUSY=*/ 1));

//From ESP32-C3 example
//GxEPD2_BW<GxEPD2_290_BS, GxEPD2_290_BS::HEIGHT> display(GxEPD2_290_BS(/*CS=*/ 10, /*DC=*/ 0, /*RST=*/ 2, /*BUSY=*/ 1));
